...
<body>
    ...
    <header>
        ...
        <section>
            <div class="hero">
                ...
                <h1 class="headline font-weight-bolder typo"><i class="fas fa-virus"> </i>LK INC</h1>
            </div>
        ...
        <div class="flex-1 ">
            ...
            <div class="right-1 rounded-lg shadow-lg">
                ...
                <p class="intro-r">
                    ...
                    <h1 class="typo font-weight-bold">Who are you</h1>
    ...
    <div class="listtile" >
        <ul>
            <li><div class="bfr">Lorem ipsum, dolor  amet  adipisicing elit. Repellendus nisi, sequi delectus quasi ipsa distinctio ut doloribus numquam beatae ab! Expibero adi</div></li>
            <li><div class="bfr">onsecteturt amet  adipisi, sequi delectus quasi ipsa distinctio ut doloribus numquam beatae ab! Expibero adi</div></li>
            <li><div class="bfr">turt amet  adipisicing elit. Repellendus nisi, sequi delectus quasi ipsa distinctio ut doloribus numquam beatae ab! Expibero adi</div></li>
            <li><div class="bfr">onsecteturt amet  adipisicing elit. Repellendus nisi, sequi delectus quasi ipsa distinctio ut doloribus numquam beatae ab! Expibero adi</div></li>
            <li><div class="bfr">Lorem ipsum, dolor adipisicing elit. Repellendus nisi, sequi delectus quasi ipsa distinctio ut doloribus numquam beatae ab! Expibero adi</div></li>
            <li><div class="bfr">onsurt amet  ipsum, dolor secteturt amet  adipisicing elit. Repellendus nisi, sequi delectus quasi ipsa distinctio ut doloribus numquam beatae ab! Expibero adi</div></li>
    ...
    <div class="text-container">
        <h1 class="text-warning font-weight-bold text-uppercase">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quod dolorem neque exercitationem,
            aspernatur
            perferendis eius iusto qui vo</h1>
    </div>
    <!-- 
    <div class="p">
